...
public class TrailingStopPercentOrderTest {
    ...
    private static Order createOrder(Order.OrderAction action, double stopPercent, double highestPrice) {
        ...
        order.setStopPercent(stopPercent);
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            ...
            {Outcome.SUCCESS, createOrder(Order.OrderAction.SELL, 2.0, 10.0), createQuote(9.80)},
            {Outcome.SUCCESS, createOrder(Order.OrderAction.SELL, 2.0, 10.0), createQuote(9.79)},
            {Outcome.NO_ORDER, createOrder(Order.OrderAction.SELL, 2.0, 10.0), createQuote(9.81)},
