...
by the caller. The interface allows the Presenter to responds to events generated by the View and
can be used in conjunction with the View public methods to drive the View.
